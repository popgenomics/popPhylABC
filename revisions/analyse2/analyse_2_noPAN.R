png(filename="figure_S4_noPAN_2.png", width = 35, height = 25, units = "cm", bg = "white", res = 900)
...
modelsMig = c("summary_3_noPAN_IM_MHetero_NHetero_robustness.txt", "summary_3_noPAN_IM_MHetero_NHomo_robustness.txt", "summary_3_noPAN_IM_MHomo_NHetero_robustness.txt", "summary_3_noPAN_IM_MHomo_NHomo_robustness.txt", "summary_3_noPAN_SC_MHetero_NHetero_robustness.txt", "summary_3_noPAN_SC_MHetero_NHomo_robustness.txt", "summary_3_noPAN_SC_MHomo_NHetero_robustness.txt", "summary_3_noPAN_SC_MHomo_NHomo_robustness.txt")
modelsNoMig = c("summary_3_noPAN_AM_MHetero_NHetero_robustness.txt", "summary_3_noPAN_AM_MHetero_NHomo_robustness.txt", "summary_3_noPAN_AM_MHomo_NHetero_robustness.txt", "summary_3_noPAN_AM_MHomo_NHomo_robustness.txt", "summary_3_noPAN_SI_NHetero_robustness.txt", "summary_3_noPAN_SI_NHomo_robustness.txt")
...
for(i in modelsMig){
	...
	tmp_mig = rbind(tmp_mig, cbind(x$netdivAB_avg*facteur, x$pMigration, x$robustness))
	if(cnt == 1){
		...
		plot(0, 0, ylim = c(0,1), ylab ="" , xlab = "net synonymous divergence", col = "white", cex.lab = 1.25, xaxt = "n", yaxt = "n", xlim=c(log10(1e-5), log10(1)), cex.axis=1.25, main="IM, SC")
		par(las=3)
