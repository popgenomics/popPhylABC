...
mig = c("IM_MHetero_NHetero", "IM_MHetero_NHomo", "IM_MHomo_NHetero", "IM_MHomo_NHomo", "SC_MHetero_NHetero", "SC_MHetero_NHomo", "SC_MHomo_NHetero", "SC_MHomo_NHomo", "PAN_NHetero", "PAN_NHomo")
...
for(i in mig){
	...
	write.table(x, file = paste("summary_3_", i, "_robustness.txt", sep=""), row.names = F, col.names = T, quote = F)
}
